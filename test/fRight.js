  ...
  describe('freeze : all rights', () => {
    ...
    describe('freeze : exclusive rights', () => {
      ...
      it('updates the tokenURI', async () => {
        ...
        assert.equal(tokenURI.toString(), `${API_BASE_URL}${_baseAssetAddress.toLowerCase()}/2/f/1585699199/1/1/1`, "tokenURI is incorrect.")
      })
    ...
    describe('freeze : non exclusive rights', () => {
      ...
      it('updates the tokenURI', async () => {
        ...
        // Confirm FRight tokenURI is correct
        assert.equal(tokenURI.toString(), `${API_BASE_URL}${_baseAssetAddress.toLowerCase()}/3/f/1585699199/0/3/1`, "tokenURI is incorrect.")
      })
